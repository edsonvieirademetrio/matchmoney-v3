...
<section id="section-1" class="mt-1 pb-5" style="background-image: url('<?php echo get_stylesheet_directory_uri(); ?>/assets/img/sobre/bk-section-1.png');margin-top: -205px !important;min-height: 640px;background-position-y: top;background-position-x: center;background-repeat: no-repeat;background-size: cover;">
    <div class="container">
        <!--Grid row-->
        <div class="row pt-15">
            <div class="col">
                <div class="title-home">
                    ...
                    <h3 class="font-weight-bold color-blue-light py-3">Sobre nós</h3>
                </div>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col">
                <h5 class="color-denin font-weight-normal text-center">
                    Conectamos
                    <span class="color-orange text-weight-bold" style="font-size: 27px !important; font-weight: bold;">empresas</span><br> com créditos garantidos a <br>
                    <span class="color-orange text-weight-bold" style="font-size: 27px !important; font-weight: bold;">qualquer investidor</span>
                </h5>
            </div>
            <div class="col">
