<section class="home-section1">
    <div class="row">
        <div class="col-xl-6">
            <!-- <h1>Seus investimentos<br>
                rendendo acima de<br>
                <span class="bg-blue">340% do CDI</span>
            </h1>
            <h3>
                Pessoas emprestando para pessoas, simples assim. Tudo isso com a segurança e rentabilidade do mercado
                imobiliário.
            </h3>
