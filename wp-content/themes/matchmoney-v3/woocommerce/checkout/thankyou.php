...
<div class="woocommerce-order">
	<?php if ( $order ) :
		...
		<?php else : ?>
			<div class="row">
				<div class="col-7 bg-color-blue text-center text-white py-3 mr-2">
					<span><i class="far fa-thumbs-up"></i></span>
					<span class="woocommerce-notice woocommerce-notice--success woocommerce-thankyou-order-received"><?php echo apply_filters( 'woocommerce_thankyou_order_received_text', esc_html__( 'Thank you. Your order has been received.', 'woocommerce' ), $order ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></span>
				</div>
				<div class="col-4 bg-color-orange text-center py-3">
					<a href="/produtos" class="text-white"><u>Quero investir mais</u></a>
				</div>
			</div>

			<div class="woocommerce-order-overview woocommerce-thankyou-order-details order_details row my-4">
