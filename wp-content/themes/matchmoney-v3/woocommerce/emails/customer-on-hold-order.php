...
<p><?php _e( 'Agradecemos seu pedido.', 'woocommerce' ); ?></p><?php // phpcs:ignore WordPress.XSS.EscapeOutput ?>
<p>Após recebermos o comprovante de seu depósito/ted/transferência via e-mail ou via upload em nosso site <strong>(Minha Conta > Meus Investimentos)</strong>, enviaremos o seu Termo de Endosso e a CCB Bancária para assinatura eletrônica.
</p>
<?php
